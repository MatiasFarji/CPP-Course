...
double a_penny_doubled_everyday(int days, double penny_to_double = 0.01);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
...
double a_penny_doubled_everyday(int days, double penny_to_double) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
    function_activation_count++;
    //----DO NOT MODIFY THE CODE ABOVE THIS LINE----
    //----WRITE THE FUNCTION BODY BELOW THIS LINE----
    if (days < 2)
        return penny_to_double;
    
    days--;
    penny_to_double *= 2;
    
    return a_penny_doubled_everyday(days, penny_to_double);
